...
def main():
    ...
    ProfundidadBits= float(input('Ingrese BitDepth: '))
    FrecuenciaMuestreo = float(input('Ingrese Frecuencia de Muestreo: '))
    Frecuencia  = float(input('Ingrese Frecuencia de la senal periodica: '))
    Duracion = float(input("ingrese el tiempo en segundos desead de su senal: ") )

    entrada = int(input("seleccione la forma de onda 1-seno 2-cuadrada"))

    print(type(Frecuencia) , type(Duracion) , type(FrecuenciaMuestreo) ,type(ProfundidadBits) )


    if entrada == 1:
        audio = seno(ProfundidadBits , FrecuenciaMuestreo ,Frecuencia, Duracion)

        arreglo = audio.generar()

        audio.graficar(arreglo)
    if entrada == 2:
        audio = square(ProfundidadBits , FrecuenciaMuestreo ,Frecuencia, Duracion)
        arreglo = audio.generar()
        audio.graficar(arreglo)
