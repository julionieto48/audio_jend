...
MainComponent::MainComponent()
{
    ...
    //rpSlider.setSliderStyle(Slider::SliderStyle::Rotary);
    ...
    addAndMakeVisible (rzSlider); rzSlider.setRange (0.0, 0.999);
    //rzSlider.setSliderStyle(Slider::SliderStyle::Rotary);
    //rzSlider.setTextBoxStyle(Slider::TextBoxBelow, false, 80 ,20);
    rzSlider.onValueChange = [this]{
    ...
    //decibelSlider.setSliderStyle(Slider::SliderStyle::Rotary);
    //decibelSlider.setTextBoxStyle(Slider::TextBoxBelow, false, 80 ,20);
    ...
    filterTypeComboBox.addItem((" Parametric Filter FFT"), 1);
...
void MainComponent::resized()
{
    ...
    filterTypeComboBox.setBounds(30, 180, getWidth() - 20, 40);
