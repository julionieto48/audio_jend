...
float *Parametricfilter::proceso(float *in, int length) {
    
    float pi = 3.141592;float omega_0 = (2*pi*f/44100);
    //Coeficientes
    double b1 = -2*r_z*cos(omega_0); double b2 = pow(r_z,2);
    double a1 = -2*r_p*cos(omega_0); double a2 = pow(r_p,2);
